...
{
    public static class ServicesInstances
    {
        #region members
        ...
        public static IUserService UserService
        {
            get
            {
                ...
                {
                    _userService = WcfHelper.CreateWCFClientByConfig<IUserService>();
        ...
        public static IValueObjectService ValueObjectService
        {
            get
            {
                ...
                {
                    _valueObjectService = WcfHelper.CreateWCFClientByConfig<IValueObjectService>();
        ...
        public static ISystemService SystemService
        {
            get
            {
                ...
                {
                    _systemService = WcfHelper.CreateWCFClientByConfig<ISystemService>();
        ...
        public static IPersonService PersonService
        {
            get
            {
                ...
                {
                    _personService = WcfHelper.CreateWCFClientByConfig<IPersonService>();
        ...
        public static IRequestService RequestService
        {
            get
            {
                ...
                { 
                    _requestService = WcfHelper.CreateWCFClientByConfig<IRequestService>();
