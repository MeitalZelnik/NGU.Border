...
namespace NGU.Core
{
    ...
    public class CImageType : ConstField    
    {
        ...
        public CImageType(string parent)
            : base(parent)
        {
        ...
        public CImageType(string value, string parent)
            : base(value, parent)
        {
	...
	/// <summary>
	/// POCO for ImageType. This class is autogenerated
	/// </summary>

	
	
	[Serializable]
	public partial  class ImageType :  MultiLanguage  	{
		#region Consts
		
		private static CImageType props = null;

		
		public static CImageType Props
        {
            get
            {
				if (props == null)
				{
					props = new CImageType();
				}
                return props;
            }
        }
		...
		/// <summary>
		/// Gets or sets the ID for the current ImageType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the Code for the current ImageType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the Name for the current ImageType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the ServerLangHub for the current ImageType
		/// </summary>
