...
namespace NGU.Core
{
    ...
    public class CRequestType : ConstField    
    {
        ...
        public CRequestType(string parent)
            : base(parent)
        {
        ...
        public CRequestType(string value, string parent)
            : base(value, parent)
        {
	...
	/// <summary>
	/// POCO for RequestType. This class is autogenerated
	/// </summary>

	
	
	[Serializable]
	public partial  class RequestType :  MultiLanguage  	{
		#region Consts
		
		private static CRequestType props = null;

		
		public static CRequestType Props
        {
            get
            {
				if (props == null)
				{
					props = new CRequestType();
				}
                return props;
            }
        }
		...
		/// <summary>
		/// Initializes a new instance of the RequestType class
		/// </summary>
		public RequestType()
		{
		}
		...
		/// <summary>
		/// Gets or sets the ID for the current RequestType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the Code for the current RequestType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the Name for the current RequestType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the ActiveRecordFlag for the current RequestType
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the ServerLangHub for the current RequestType
		/// </summary>
