...
namespace NGU.Core
{
    ...
    public class CRequestReason : ConstField    
    {
        ...
        public CRequestReason(string parent)
            : base(parent)
        {
        ...
        public CRequestReason(string value, string parent)
            : base(value, parent)
        {
	...
	/// <summary>
	/// POCO for RequestReason. This class is autogenerated
	/// </summary>

	
	
	[Serializable]
	public partial  class RequestReason :  MultiLanguage  	{
		#region Consts
		
		private static CRequestReason props = null;

		
		public static CRequestReason Props
        {
            get
            {
				if (props == null)
				{
					props = new CRequestReason();
				}
                return props;
            }
        }
		...
		/// <summary>
		/// Initializes a new instance of the RequestReason class
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the ID for the current RequestReason
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the Code for the current RequestReason
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the Name for the current RequestReason
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the IsActiveRecord for the current RequestReason
		/// </summary>
...
*/
		...
		/// <summary>
		/// Gets or sets the ServerLangHub for the current RequestReason
		/// </summary>
