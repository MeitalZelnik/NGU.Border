...
namespace NGU.BlackList.DAL
{
    ...
    {
        /*
        public ICriteria GenerateSearchRequestsByName(string firstName, string lastName, bool isPartial)
        {
        ...
        public ICriteria SearchRequestsByCreationDate(DateTime? createdFrom, DateTime? createdTo)
        {
            ICriteria criteria = Session.CreateCriteria<Request>().Add(Restrictions.IsNotNull(Request.Props.Num));
        ...
        public ICriteria SearchRequestsByIdentifier(int? selectedIDTypeID, string iDNumber, int? selectedCountryID)
        {
            ICriteria criteria = Session.CreateCriteria<Request>().Add(Restrictions.IsNotNull(Request.Props.Num));
        ...
        public ICriteria SearchRequestsByID(string internalFileNo, string requestNo, int? requestTypeID, int? requestStatusID)
        {
            ICriteria criteria = Session.CreateCriteria<Request>().Add(Restrictions.IsNotNull(Request.Props.Num));
    ...
    */
        ...
        public List<BlackListLog> GetBlackListLog(string num)
        {
            ICriteria criteria = Session.CreateCriteria<BlackListLog>().Add(Restrictions.Eq(Request.Props.Num, num));
            List<BlackListLog> list = criteria.List<BlackListLog>().ToList();
            return list;
        }
    }
}
